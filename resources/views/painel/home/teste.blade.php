...
<html lang="pt-br">
 ...
 <head>
    <meta charset="utf-8">
    <title>Fox Priston Tale</title>
    <meta property="og:title" content="Fox Priston Tale">
    <meta property="robots" content="index,follow">
    <meta property="og:site_name" content="Fox">
    <meta property="og:locale" content="pt-BR">
    <meta property="og:type" content="website">
    <meta property="og:author" content="Fox Priston Tale">
    <meta property="og:url" content="https://www.foxpristontale.com.br/">
    <meta property="og:description" content="Melhor Servidor de Priston tale">
    <meta name="keywords" content="Melhor Servidor de Priston tale">
    <meta property="og:image" content="./images/logos/logo.png">
    <meta property="og:image:type" content="image/png">
    <meta property="og:image:width" content="1024">
    <meta property="og:image:height" content="536">
    <meta name="author" content="Fox Priston Tale">
    <meta name="viewport" content="width=device-width">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:creator" content="Priston Tale">
    <meta property="twitter:description" content="foxpristontale.com.br -Melhor Servidor de Priston tale">


    <link rel="shortcut icon" href="./img/favicon/favicon.png">
    <link rel="apple-touch-icon" sizes="256x256" href="./img/favicon/favicon.png">

    <link rel="stylesheet" href="./libs/fontawesome-free-6.2.1-web/css/all.min.css" type="text/css">
...
.pagination a {
    ...
    align-items: center;
    border-radius: 5px;
    border: 1px solid rgba(134, 128, 126, .6);
    font-family: var(--primary-font);
    font-size: 16px;
    line-height: 1em;
    color: #b3afae;
...
.nav__item-text--dropdown:after {
    content: "";
    width: 12px;
    aspect-ratio: 15/8;
    position: relative;
    background: url("../img/icons/nav_arrow_icon.png");
...
@media(max-width: 1024px) {
    ...
    .nav__item-text--dropdown.active:after {
        transform: scale(1, -1)
    }
}
...
.nav__item-stroke li:not(:first-child) {
    margin-top: 10px
}

.nav__item-stroke li a {
    font-family: var(--primary-font);
    font-size: 15px;
    line-height: 1em;
    color: #e5e5e5;
...
@media(min-width: 1024px) {
    ...
    .nav__item:hover .nav__item-text--dropdown:after {
        transform: scale(1, -1)
    }
}
...
.header__server .header__server-item-position:hover {
    z-index: 2
}
...
.header__server .header__server-item:hover {
    background-color: #1f1510
}

.header__server .header__server-item:hover .header__server-item-online {
    grid-template-rows: 1fr
}

.header__server .header__server-item:hover .header__server-item-online>div {
    margin-top: 10px
}

.header__server .header__server-item:hover:before {
    transform: scale(1, -1)
}

.header__server .header__server-item:before {
    content: "";
    width: 16px;
    aspect-ratio: 22/10;
    position: absolute;
    top: 32px;
    right: 20px;
    background: url("../img/icons/header__server-item-arrow.png") center center no-repeat;
    transition: transform .3s ease-in-out;
    cursor: pointer
}
...
.header__server .header__server-item-name span {
    color: #ffc24c
}
...
.server-section-sliders .server-section-slider-nav .slick-list .slick-slide:not(.slick-current) .server-section-slider-nav-item {
    border: 1px solid rgba(217, 157, 63, .549);
    background-color: rgba(28, 22, 18, .502);
...
.server-section-sliders .server-section-slider-for-item {
    background-color: rgba(28, 22, 18, .5);
    position: relative;
    margin-top: 20px;
    padding: 30px 30px;
    border-radius: 10px
...
@media(max-width: 1024px) {
    .server-section-sliders .server-section-slider-for-item {
        background-color: rgba(28, 22, 18, .8)
    }
}
...
.footer {
    background-color: rgba(36, 26, 21, .8);
    position: relative;
    z-index: 10;
    padding: 80px 0px
}
...
.footer__cpr-vote-items a.l2top:hover {
    background-color: rgba(232, 117, 55, .2)
}
...
.footer__cpr-vote-items a.l2jbrasil:hover {
    background-color: rgba(126, 180, 25, .2)
}
...
.footer__cpr-vote-items a.l2network:hover {
    background-color: rgba(107, 116, 201, .2)
}
...
.footer__cpr-vote-items a.hopzone:hover {
    background-color: rgba(109, 167, 160, .2)
}
...
.slick-next.slick-next {
    ...
    height: auto;
    aspect-ratio: 31/40;
    background: url(../img/icons/slider-right.png);
    background-size: 100% 100%
}
...
.slick-next.slick-prev {
    ...
    height: auto;
    aspect-ratio: 31/40;
    background: url(../img/icons/slider-left.png);
    background-size: 100% 100%
}
...
.form__switch-item:after {
    ...
    top: 0;
    left: 0;
    background: linear-gradient(to top, rgb(147, 117, 72) 0%, rgb(86, 59, 19) 100%);
    opacity: 0;
    transition: opacity .3s ease-in-out
}
...
.form__group-error {
    width: 100%;
    padding: 10px 16px;
    background-color: rgba(197, 17, 17, .4);
    font-size: 14px;
    line-height: 1.2em;
    border-radius: 10px;
    color: #fca6a6
...
.form button:before {
    ...
    bottom: 0;
    left: 0;
    background: linear-gradient(to top, rgb(228, 184, 118) 0%, rgb(167, 116, 39) 100%);
    opacity: 0;
    transition: opacity .3s ease-in-out
}
...
.text-area .spoiler__content {
    background-color: rgba(71, 55, 39, .3);
    width: 100%;
    padding: 20px;
    display: none;
    border-radius: 5px
...
<nav class="nav">
            <div class="content-area">
                ...
                <div class="nav__links">
                    ...
                    <div class="nav__item">
                        <div class="nav__item-text nav__item-text--dropdown">
                            <span>CONTA</span>
                        </div>
                        <ul class="nav__item-stroke">
                            <li><a href="/painel/login.php">Painel de controle</a></li>
                            <li><a href="/painel/index.php">Cadastrar</a></li>
                    ...
                    <div class="nav__item">
                        ...
                        <ul class="nav__item-stroke">
                            <li><a href="sobre.php">Sobre o servidor</a></li>
                    ...
                    <div class="nav__item">
                        ...
                        <ul class="nav__item-stroke">
                            <li><a href="/RankingLevel.php">Ranking Level</a></li>
                            <li><a href="/RankingPvp.php">Ranking PvP</a></li>
                            <li><a href="/RankingBellatraSolo.php">Bellatra Solo</a></li>
                            <li><a href="/RankingBellatraClan.php">Bellatra Clan</a></li>
                            <li><a href="/ClanList.php">Lista de Clans</a></li>
                    ...
                    <div class="nav__item">
                        ...
                        <ul class="nav__item-stroke">                          
                            <li><a href="/drop.php">Históricos de Drops</a></li>
                            <li><a href="/dropboss.php">Históricos de Drops Boss</a></li>
                        </ul>
                    </div>
                    <div class="nav__item">
                        <a href="/doacao.php" class="nav__item-text">
                            <span>DOAÇÃO</span>
                        </a>
                    </div>
                ...
                <div class="langs flex-cc">
                    <a href="download.php" class="gray-btn nav__account-btn">
                ...
                <div class="header__content flex-sbe">
                    ...
                    <div class="header__info">
                        ...
                        <a href="#" class="header__logo flex-cc">
                            <img src="./img/logos/header_logo.png" alt="logotype">
                        </a>
                        <!-- END LOGO -->


                        <div class="header__info-title">O melhor
                            <span>Servidor UP</span>
                        </div>
                        <a href="https://drive.google.com/file/d/1mgmW7fIog33OYEdqIvXyKQU8rCc8_YQI/view?usp=sharing" class="header__link">
                        ...
                        <div class="header__server-item-position">
                            <div class="header__server-item">
                                <div class="header__server-item-icon">
                                    <!--<img src="/Clancontent/1000000047.bmp" alt="server icon"> -->
                                </div>
                                <div class="header__server-item-description">
                                    <div class="header__server-item-info">
                                        <div class="header__server-item-name">Clan: <span>OldSchool</span></div>
                                        <div class="header__server-item-text">Pontuação: <span>15602344</span></div>
                                    </div>
                                    <div class="header__server-item-online">
                                        <div>
                                            <div class="header__server-item-online-item">
                                                Data: <span>16/07 17:39</span>
                                            </div>                                          
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="header__news">
                    <div class="header__news-item">
                        <div class="header__news-item-border">
                            <img class="border-icon-top" src="./img/icons/border-icon-top.png" alt="border icon top">
                        </div>
                        <a href="#" class="header__news-item-img">
                            <img src="./img/bg/news-01.png" alt="Noticias">
                        </a>
                        ...
                        <div class="header__news-item-buttons">
                            <a href="https://www.foxpristontale.com.br/painel" class="gray-btn">
                                <span>CADASTRE-SE</span>
                            </a>
                            <a href="/download" target="_blank" class="gray-btn">
                                <span>DOWNLOAD</span>
                            </a>
                        </div>
                    </div>
                    <div class="header__news-item">
                        ...
                        <a href="/login" class="header__news-item-img">
                            <img src="./img/bg/news-02.png" alt="Noticias">
                        </a>
                    ...
                    <div class="header__news-item">
                        ...
                        <a href="/sobre"  class="header__news-item-img">
                            <img src="./img/bg/news-03.png" alt="img">
                        </a>
                        ...
                        <div class="server-section-slider-for">
                            ...
                            <div class="server-section-slider-for-item">
                                ...
                                <div class="server-section-slider-for-item-text">
                                    Não perca o TIME de acompanhar e superar seus adversários!
                                </div>
                                <div class="server-section-slider-for-item-specifics">
                                    <div>EXP:<span> hard</span></div>
                                    <div>drop:<span> hard</span></div>
                                    <div>gold:<span> hard</span></div>

                                </div>
                                <div class="server-section-slider-for-item-buttons">
                                    <a href="/download"  class="gray-btn">
                                        <span>jogar agora!</span>
                                    </a>
                                </div>
                                <center><br><iframe src="https://discord.com/widget?id=1085748083360538644&theme=dark" width="500" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe></center>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <section class="streams">
                    <div class="content-area flex-sbe">
                        <div class="streams-slider">
                            ...
                            <div class="streams-item__content streams__slider-item-content">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/jVYOAhhby38?si=rexXBSDFhMorrS34" title="Fox Priston Tale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                            <div class="streams-item__content streams__slider-item-content">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/OVUSGjYU1T0?si=sbNR7rLSG5itbkSV" title="Fox Priston Tale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>

                            <div class="streams-item__content streams__slider-item-content">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/t16VDDId-lo?si=ZRL41OY6SgeD_PFx" title="Fox Priston Tale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>

                            <div class="streams-item__content streams__slider-item-content">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/i1SNL90UKdU?si=2CpIA4JTDrH-I3fr" title="Fox Priston Tale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>

                            <div class="streams-item__content streams__slider-item-content">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/McrVFJm3DR4?si=cRIiYbaC-nIepCiO" title="Fox Priston Tale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                            <div class="streams-item__content streams__slider-item-content">
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/OVUSGjYU1T0?si=sbNR7rLSG5itbkSV" title="Fox Priston Tale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
        ...
        <footer class="footer">
            <div class="content-area flex-ss">
                <div class="footer__cpr">
                    <div class="footer__cpr-years">© 2024 FOXTALE</div>
                    <div class="footer__cpr-text">

                        FOX PRISTON TALE É UM SERVIDOR PRIVADO, CRIADO E MANTIDO PARA <br>A PROGRAMAÇÃO EDUCACIONAL E
                        NÃO COMERCIAL DO JOGO PRISTON TALE®
                    </div>


                    <a class="unsimple" href="https://www.instagram.com/ricardoferreir4/" target="_blank" rel="dofollow"
                        title="Ricardo Ferrero">

                        <span>Developed by<br><b>Ricardo Ferrero</b></span>
                    </a>
                </div>

                <div class="footer__nav flex-sc">
                    <div class="footer__nav-group">
                        <div class="footer__nav-group-title">Informações</div>
                        <ul>
                            <li><a href="/sobre">Sobre o servidor</a></li>
                    ...
                    <div class="footer__nav-group">
                        <div class="footer__nav-group-title">Conta</div>
                        <ul>
                            <li><a href="https://foxpristontale.com.br/painel/register">Cadastro</a></li>
                            <li><a href="/login">Painel de controle</a></li>
                            <li><a href="/login">Recuperar Senha</a></li>
    ...
    <script src="./js/MVisionToggleClass.js"></script>
